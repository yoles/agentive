...
* :mod:`.value_objects` — ``NamespaceType``, ``RetentionPolicy`` (single
  ...
  and ``DecayPolicy`` (its twin over ``namespaces.decay_policy``; owns the
  read-time "how much is a chunk of this age still worth" decision, Story
  3.4).
