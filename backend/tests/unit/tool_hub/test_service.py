...
Spec demands ≥ 5 tests in ``tests/unit/tool_hub/test_service.py`` (T6.2).
...
from agentive_backend.features.tool_hub import service as svc_module
...
async def test_invoke_tool_happy_path_returns_call_tool_result(
    ...
    assert captured_event["event_type"] == "tool_hub.tool.invoked"
