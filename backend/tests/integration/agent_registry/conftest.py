"""Integration fixtures for ``features.agent_registry`` tests — Story 2.1.
...
ajouteront des e2e tests agent_registry consommeront ce helper.
"""
...
def make_e2e_app(
    *,
    ...
    """Build a minimal FastAPI app exercising the full agent_registry stack.
